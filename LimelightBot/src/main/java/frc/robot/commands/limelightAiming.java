...
public class limelightAiming extends CommandBase {
     ...
     */
    public limelightAiming(double degrees, DriveTrain drivetrain, LimeLight limelight) {
    ...
    public limelightAiming(DriveTrain drivetrain, LimeLight limelight) {
    m_drivetrain = drivetrain;
    m_limelight = limelight;
    m_degrees = 0;

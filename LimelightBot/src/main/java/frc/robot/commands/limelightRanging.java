 ...
 */
public class limelightRanging extends CommandBase {
     ...
     * @param limelight
     */
    public limelightRanging(DriveTrain drivetrain, LimeLight limelight) {
    ...
    /**
     * Use this constructor if we have not calibrated for the distance we want, or
     * for whatever else reason their might be. Will use our current distance to
     * adjust our error.
     * 
     * @param drivetrain
     * @param limelight
     ...
     */
    public limelightRanging(DriveTrain drivetrain, LimeLight limelight, double desiredDistance) {
    m_drivetrain = drivetrain;
    m_limelight = limelight;
